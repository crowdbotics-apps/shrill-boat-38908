"""
Django settings for shrill_boat_38908 project.
...
ROOT_URLCONF = 'shrill_boat_38908.urls'
...
WSGI_APPLICATION = 'shrill_boat_38908.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "shrill_boat_38908 API",
    "DESCRIPTION": "API documentation for shrill_boat_38908 App",
    "VERSION": "v1",
}
